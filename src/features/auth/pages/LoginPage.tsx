...
import { clientLoginSchema, ClientLoginInput } from "../validations/authValidation.js";
...
export const LoginPage: React.FC = () => {
  ...
  const onSubmit = async (data: ClientLoginInput) => {
    ...
    try {
      ...
      setErrorMessage(
        err?.data?.message || "Invalid email or password. Please verify your credentials."
      );
    }
  };
      ...
      >
        <div className="flex flex-col items-center text-center">
          ...
          <p className="mt-2 font-sans text-sm text-gray-500 dark:text-zinc-400">
            Access your custom training and real-time assessments
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            <div>
              ...
              <div className="relative mt-1">
                ...
                <input
                  ...
                  type="email"
                  id="email-input"
                  className="block w-full rounded-lg border border-gray-200 bg-gray-50 py-2.5 pl-10 pr-3 text-sm text-gray-900 placeholder-gray-400 focus:border-indigo-500 focus:bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500/20 dark:border-zinc-800 dark:bg-zinc-950 dark:text-white dark:placeholder-zinc-600 dark:focus:border-indigo-600"
            ...
            <div>
              <div className="flex items-center justify-between">
                ...
                <a href="#" className="font-sans text-xs font-semibold text-indigo-600 hover:text-indigo-500 dark:text-indigo-400">
                  Forgot Password?
                </a>
              </div>
              <div className="relative mt-1">
